...
async fn main() {
    ...
    let error_swap_details = SwapDetailsBuilder::new()
        ...
        .src(dst) // In this example we`ll swap XRP to USDT. Since my account doesn't have any xrp balance and
        // allowance for the 1inch contract -
