...
/// Struct represents list of tokens that are available for swap. We use it to performing /tokens request
/// In fact the struct is just hashmap where string key is token`s address and its value is TokenInfo object.
